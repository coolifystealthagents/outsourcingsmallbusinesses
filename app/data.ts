...
export const blogPosts = [
  ...septemberTwoBlogBatch.map((post) => ({ ...post, minutes: 10 })),
  ...septemberOneBlogBatch.map((post) => ({ ...post, minutes: 10 })),
  ...augustThirtyOneBlogBatch.map((post) => ({ ...post, minutes: 10 })),
  ...
  ...augustSeventeenBlogBatch.map((post) => ({ ...post, minutes: 9 })),
  ...augustFourteenBlogBatch.map((post) => ({ ...post, minutes: 9 })),
  ...augustThirteenBlogBatch.map((post) => ({ ...post, minutes: 9 })),
  ...augustElevenBlogBatch.map((post) => ({ ...post, minutes: 9, publicationDate: '2026-08-12' as const })),
